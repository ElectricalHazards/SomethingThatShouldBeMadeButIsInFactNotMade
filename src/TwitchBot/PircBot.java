...
public abstract class PircBot implements ReplyConstants {
    ...
    protected void handleLine(String line) {
        ...
        if(tokenizer.nextToken().indexOf("@badge-info")==0){ }
        ...
        if (command.equals("PRIVMSG") && line.indexOf(":\u0001") > 0 && line.endsWith("\u0001")) {
            ...
            this.onMessage(target, sourceNick, sourceLogin, sourceHostname, line.substring(line.indexOf(" :") + 2).substring(line.substring(line.indexOf(" :") + 2).indexOf(" :")+2));
        }
        else if (command.equals("PRIVMSG")) {
            // This is a private message to us.
            this.onPrivateMessage(sourceNick, sourceLogin, sourceHostname, line.substring(line.indexOf(" :") + 2).substring(line.substring(line.indexOf(" :") + 2).indexOf(" :")+2));
        }
